...
document.addEventListener('DOMContentLoaded', () => {
    ...
    @if(session('success'))
        window.notify('{{ __("portal.general.success") }}', '{{ session("success") }}', 'success');
    @endif
    
    @if(session('error'))
        window.notify('{{ __("portal.general.error") }}', '{{ session("error") }}', 'error');
    @endif
    
    @if(session('warning'))
        window.notify('{{ __("portal.general.warning") }}', '{{ session("warning") }}', 'warning');
    @endif
    
    @if(session('info'))
        window.notify('{{ __("portal.general.info") }}', '{{ session("info") }}', 'info');
    @endif
});
</script> 
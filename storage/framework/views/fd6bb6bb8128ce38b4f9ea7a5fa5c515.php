...
<head>
    ...
    <!-- Current Locale -->
    <meta name="current-locale" content="<?php echo e(app()->getLocale()); ?>">

    <!-- Tenant Date/Time Formats -->
    <?php if(auth()->guard()->check()): ?>
        <?php if(auth()->user()->tenant): ?>
            <meta name="tenant-date-format" content="<?php echo e(auth()->user()->tenant->date_format); ?>">
            <meta name="tenant-time-format" content="<?php echo e(auth()->user()->tenant->time_format); ?>">
            <meta name="tenant-timezone" content="<?php echo e(auth()->user()->tenant->timezone?->name ?? 'UTC'); ?>">
        <?php endif; ?>
    <?php endif; ?>
    ...
    <?php if(auth()->guard()->check()): ?>
        <?php if(auth()->user()->tenant): ?>
            ...
            ?>
            <meta name="tenant-datetime" content='<?php echo e(json_encode($tenantDateTime)); ?>'>
        <?php endif; ?>
    <?php endif; ?>
    ...
    <script>
        window.translations = {
            navigation: <?php echo json_encode(__('portal.navigation'), 15, 512) ?>,
            header: <?php echo json_encode(__('portal.header'), 15, 512) ?>,
            profile_menu: <?php echo json_encode(__('portal.profile_menu'), 15, 512) ?>,
            footer: <?php echo json_encode(__('portal.footer'), 15, 512) ?>,
            general: <?php echo json_encode(__('portal.general'), 15, 512) ?>
        };
        window.locale = '<?php echo e(app()->getLocale()); ?>';
    </script>

    <title><?php echo $__env->yieldContent('title', __('portal.title')); ?> - <?php echo e(config('app.name', 'Meet2Be')); ?></title>
    ...
    <!-- Scripts -->
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/portal/portal.css', 'resources/js/portal/portal.js']); ?>
</head>
<body class="h-full font-inter antialiased bg-gray-50 dark:bg-gray-900">
    <!-- Notification System -->
    <?php echo $__env->make('components.portal.notification', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        ...
                        <div class="px-3 border-t border-gray-200 dark:border-gray-700 pt-4 space-y-1">
                            ...
                            <a href="/portal/user" 
                               ...
                               :class="{
                                ...
                                <?php echo e(__('portal.navigation.users')); ?>

                            </a>
                            
                            <!-- Settings -->
                            <a href="<?php echo e(route('portal.setting.index')); ?>" 
                               ...
                               :class="{
                                ...
                                <?php echo e(__('portal.navigation.settings')); ?>
                ...
                <div class="flex h-16 items-center justify-between px-4 sm:px-6 gap-2">
                    ...
                    <div class="flex-1 flex items-center">
                        <div class="w-full max-w-md lg:max-w-xs">
                            <label for="search" class="sr-only"><?php echo e(__('portal.header.search')); ?></label>
                            <div class="relative">
                                ...
                                <input id="search"
                                       ...
                                       placeholder="<?php echo e(__('portal.header.search_placeholder')); ?>"
                                       type="search">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-1 sm:gap-2 flex-shrink-0">
                        ...
                        <button @click="toggleTheme()"
                                ...
                                aria-label="<?php echo e(__('portal.header.toggle_theme')); ?>">
                        ...
                        <button class="relative p-1.5 sm:p-2 rounded-lg transition-colors duration-150"
                                aria-label="<?php echo e(__('portal.header.notifications')); ?>">
                        ...
                        <div x-data="{ open: false }" class="relative">
                            <button @click="open = !open"
                                    ...
                                    :aria-expanded="open"
                                    aria-haspopup="true"
                                    aria-label="<?php echo e(__('portal.header.user_menu')); ?>">
                                <div class="h-7 w-7 sm:h-8 sm:w-8 rounded-full bg-gradient-to-br from-blue-600 to-blue-700 dark:from-blue-500 dark:to-blue-600 flex items-center justify-center shadow-sm">
                                    <span class="text-xs sm:text-sm font-medium text-white">
                                        <?php echo e(substr(auth()->user()->full_name ?? auth()->user()->first_name ?? 'K', 0, 1)); ?>

                                    </span>
                                </div>
                                <span class="hidden ml-2 sm:ml-3 text-sm font-medium text-gray-700 dark:text-gray-200 lg:block">
                                    <?php echo e(auth()->user()->full_name ?? __('portal.header.default_user')); ?>
                            ...
                            <div x-show="open"
                                ...
                                <a href="<?php echo e(route('portal.profile.index')); ?>" 
                                   ...
                                   role="menuitem">
                                    ...
                                    <?php echo e(__('portal.profile_menu.profile')); ?>

                                </a>
                                
                                <hr class="my-1 border-gray-200 dark:border-gray-700">
                                
                                <form method="POST" action="<?php echo e(route('site.auth.logout')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" 
                                        ...
                                        <?php echo e(__('portal.profile_menu.logout')); ?>
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-between gap-2 text-xs sm:text-sm">
                        ...
                        <div class="text-gray-600 dark:text-gray-400">
                            <span class="hidden sm:inline">
                                <?php echo e(__('portal.footer.copyright', [
                                    'year' => date('Y'),
                            ...
                            <span class="sm:hidden">
                                © <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'Meet2Be')); ?>
                        ...
                        <div class="flex items-center gap-2 sm:gap-4 text-gray-600 dark:text-gray-400">
                            <span><?php echo e(__('portal.footer.version', ['version' => config('app.version', '1.0.0')])); ?></span>
                            <span class="hidden sm:inline">•</span>
                            <span class="hidden sm:inline">
                                <?php echo e(__('portal.footer.made_with')); ?>

                                <i class="fa-solid fa-heart text-red-500 mx-1"></i>
                                <?php echo e(__('portal.footer.by')); ?>
...
<?php /**PATH C:\Users\Ali Erdem Sunar\Documents\Projects\meet2be.com\resources\views/layouts/portal.blade.php ENDPATH**/ ?>